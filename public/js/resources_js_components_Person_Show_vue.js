...
var render = function () {
  ...
  return _c(
    ...
    [
      _vm.person
        ? _c("div", [
            _c("p", [_vm._v("Name: " + _vm._s(_vm.person.name))]),
            _vm._v(" "),
            _c("p", [_vm._v("Age: " + _vm._s(_vm.person.age))]),
            _vm._v(" "),
            _c("p", [_vm._v("Job: " + _vm._s(_vm.person.job))]),
          ])
        : _vm._e(),
      _vm._v(" "),
      _c(
        "router-link",
        {
          ...
          attrs: { to: { name: "person.edit", params: { id: _vm.person.id } } },
        },
        [_vm._v("Edit")]
      ),
      _vm._v(" "),
        ...
        "a",
        {
          ...
          on: {
            click: function ($event) {
              ...
              return _vm.$store.dispatch("deletePerson", _vm.person.id)
            },
          },
        },
        [_vm._v("Delete")]
